...
*/
                    ...
                    goog.loadModule = function(a) {
                        ...
                        try {
                            ...
                            if ("string" === typeof e && e)
                                goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(e, d, c !== d) : goog.SEAL_MODULE_EXPORTS && Object.seal && "object" == typeof d && null != d && Object.seal(d),
                            ...
                            if (h || g)
                                ...
                                if (f && goog.inHtmlDocument_() && goog.isDocumentLoading_() && !h) {
                                    ...
                                    k.onreadystatechange = function() {
                                        "interactive" == k.readyState && (k.onreadystatechange = l,
                                        c(),
                                        a.resume());
                    ...
                    function module$contents$goog$array_removeLast(a, b) {
                        ...
                        return 0 <= b ? (module$contents$goog$array_removeAt(a, b),
                        !0) : !1
                    }
                    ...
                    function module$contents$goog$array_binaryInsert(a, b, c) {
                        ...
                        return 0 > c ? (module$contents$goog$array_insertAt(a, b, -(c + 1)),
                        !0) : !1
                    }
                    ...
                    goog.html.SafeUrl.sanitizeExtensionUrl_ = function(a, b, c) {
                        (a = a.exec(b)) ? (a = a[1],
                        -1 == (c instanceof goog.string.Const ? [goog.string.Const.unwrap(c)] : c.map(function(d) {
                    ...
                    goog.html.SafeUrl.sanitizeAssertUnchanged = function(a, b) {
                        if (a instanceof goog.html.SafeUrl)
                            return a;
                        a = "object" == typeof a && a.implementsGoogStringTypedString ? a.getTypedStringValue() : String(a);
                        if (b && /^data:/i.test(a) && (b = goog.html.SafeUrl.fromDataUrl(a),
                    ...
                    module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.fromConstant = function(a) {
                        ...
                        goog.string.internal.contains)(a, "<"), "Forbidden '<' character in style sheet string: " + a);
                        return module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse(a)
                    }
                    ;
                    ...
                    goog.html.SafeHtml.join = function(a, b) {
                        ...
                        var c = a.getDirection()
                          ...
                          , e = function(f) {
                            ...
                            d.push(goog.html.SafeHtml.unwrap(f)),
                            f = f.getDirection(),
                            c == goog.i18n.bidi.Dir.NEUTRAL ? c = f : f != goog.i18n.bidi.Dir.NEUTRAL && c != f && (c = null))
                        };
                    ...
                    goog.html.SafeHtml.combineAttributes = function(a, b, c) {
                        var d = {}, e;
                        for (e in a)
                            Object.prototype.hasOwnProperty.call(a, e) && (goog.asserts.assert(e.toLowerCase() == e, "Must be lower case"),
                            d[e] = a[e]);
                        for (e in b)
                            Object.prototype.hasOwnProperty.call(b, e) && (goog.asserts.assert(e.toLowerCase() == e, "Must be lower case"),
                            d[e] = b[e]);
                        if (c)
                            for (e in c)
                        ...
                        for (var b = this.getDescriptor().getFields(), c = 0; c < b.length; c++) {
                            ...
                            if (a.has$Value(e)) {
                                ...
                                if (d.isRepeated()) {
                                    ...
                                    d = a.getValueForTag_(e),
                                    f ? (f = this.getValueForTag_(e)) ? f.mergeFrom(d) : this.set$Value(e, d.clone()) : this.set$Value(e, d)
                            }
                        }
                    }
                    ;
                    ...
                    goog.proto2.Message.prototype.get$Value = function(a, b) {
                        ...
                        return this.fields_[a].isRepeated() ? (a = b || 0,
                        goog.asserts.assert(0 <= a && a < c.length, "Given index %s is out of bounds.  Repeated field length: %s", a, c.length),
                        c[a]) : c
                    }
                    ;
                    ...
                    goog.proto2.Serializer.prototype.getDeserializedValue = function(a, b) {
                        ...
                        if (a.getFieldType() == goog.proto2.FieldDescriptor.FieldType.ENUM)
                            return goog.proto2.Serializer.DECODE_SYMBOLIC_ENUMS && "string" === typeof b && (a = a.getNativeType(),
...
*/
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_ = function(a, b, c) {
                        for (var d = new goog.string.StringBuffer, e, f, g = a.length, h = 0; h < g; ++h)
                            e = a.charAt(h),
                            f = b[e.toUpperCase()],
                            null != f ? d.append(f) : c || d.append(e);
                        return d.toString()
                    }
                    ;
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.formatInOriginalFormat = function(a, b) {
                        ...
                        default:
                            ...
                            d = this.getNationalSignificantNumber(a),
                            c = this.chooseFormattingPatternForNumber_(c.numberFormatArray(), d),
                            null != c)) {
                                ...
                                0 != d.length && (b = c.clone(),
                                b.clearNationalPrefixFormattingRule(),
                                b = this.formatByPattern(a, i18n.phonenumbers.PhoneNumberFormat.NATIONAL, [b])))
                            }
                        }
                        a = a.getRawInputOrDefault();
                        null != b && 0 < a.length && (c = i18n.phonenumbers.PhoneNumberUtil.normalizeDiallableCharsOnly(b),
                        d = i18n.phonenumbers.PhoneNumberUtil.normalizeDiallableCharsOnly(a),
                        c != d && (b = a));
                        return b
                    }
                    ;
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.formatOutOfCountryKeepingAlphaChars = function(a, b) {
                        ...
                        b = "";
                        null != f && (b = f.getInternationalPrefixOrDefault(),
                        b = i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(i18n.phonenumbers.PhoneNumberUtil.SINGLE_INTERNATIONAL_PREFIX_, b) ? b : f.getPreferredInternationalPrefixOrDefault());
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.chooseFormattingPatternForNumber_ = function(a, b) {
                        for (var c, d = a.length, e = 0; e < d; ++e) {
                            ...
                            if (0 == f || 0 == b.search(c.getLeadingDigitsPattern(f - 1)))
                                if (f = new RegExp(c.getPattern()),
                                i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(f, b))
                                    return c
                        }
                        return null
                    }
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.formatNsnUsingPattern_ = function(a, b, c, d) {
                        ...
                        e = e.replace(i18n.phonenumbers.PhoneNumberUtil.FIRST_GROUP_PATTERN_, b),
                        a = a.replace(f, e)) : (b = b.getNationalPrefixFormattingRuleOrDefault(),
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.testNumberLengthForType_ = function(a, b, c) {
                        ...
                        if (c == i18n.phonenumbers.PhoneNumberType.FIXED_LINE_OR_MOBILE)
                            if (i18n.phonenumbers.PhoneNumberUtil.descHasPossibleNumberData_(i18n.phonenumbers.PhoneNumberUtil.getNumberDescByType_(b, i18n.phonenumbers.PhoneNumberType.FIXED_LINE)))
                                c = i18n.phonenumbers.PhoneNumberUtil.getNumberDescByType_(b, i18n.phonenumbers.PhoneNumberType.MOBILE),
                                ...
                                e.sort(),
                                0 == d.length ? d = c.possibleLengthLocalOnlyArray() : (d = d.concat(c.possibleLengthLocalOnlyArray()),
                                d.sort()));
                            else
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.truncateTooLongNumber = function(a) {
                        ...
                        do
                            if (c = Math.floor(c / 10),
                            b.setNationalNumber(c),
                            0 == c || this.isPossibleNumberWithReason(b) == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_SHORT)
                                return !1;
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.extractCountryCode = function(a, b) {
                        ...
                        for (var c, d = a.length, e = 1; e <= i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_COUNTRY_CODE_ && e <= d; ++e)
                            if (c = parseInt(a.substring(0, e), 10),
                            c in i18n.phonenumbers.metadata.countryCodeToRegionCodeMap)
                                return b.append(a.substring(e)),
                                c;
                        return 0
                    }
                    ;
                    i18n.phonenumbers.PhoneNumberUtil.prototype.maybeExtractCountryCode = function(a, b, c, d, e) {
                        ...
                        if (null != b) {
                            ...
                            this.maybeStripNationalPrefixAndCarrierCode(g, b, null),
                            g = g.toString(),
                            !i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(h, a.toString()) && i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(h, g) || this.testNumberLength_(a.toString(), b) == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_LONG))
                                return c.append(g),
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripInternationalPrefixAndNormalize = function(a, b) {
                        ...
                        if (i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN.test(c))
                            return c = c.replace(i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN, ""),
                            a.clear(),
                            a.append(i18n.phonenumbers.PhoneNumberUtil.normalize(c)),
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.prototype.parseHelper_ = function(a, b, c, d) {
                        ...
                        0 != g ? (e = this.getRegionCodeForCountryCode(g),
                        e != b && (f = this.getMetadataForRegionOrCallingCode_(g, e))) : (i18n.phonenumbers.PhoneNumberUtil.normalizeSB_(e),
                        a.append(e.toString()),
                        null != b ? (g = f.getCountryCodeOrDefault(),
                        d.setCountryCode(g)) : c && d.clearCountryCodeSource());
                        if (a.getLength() < i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_FOR_NSN_)
                            throw Error(i18n.phonenumbers.Error.TOO_SHORT_NSN);
                        null != f && (b = new goog.string.StringBuffer,
                        e = new goog.string.StringBuffer(a.toString()),
                        this.maybeStripNationalPrefixAndCarrierCode(e, f, b),
                        f = this.testNumberLength_(e.toString(), f),
                        g = i18n.phonenumbers.PhoneNumberUtil.ValidationResult,
                        f != g.TOO_SHORT && f != g.IS_POSSIBLE_LOCAL_ONLY && f != g.INVALID_LENGTH && (a = e,
                    ...
                    i18n.phonenumbers.PhoneNumberUtil.copyCoreFieldsOnly_ = function(a) {
                        ...
                        a.getItalianLeadingZero() && (b.setItalianLeadingZero(!0),
                        b.setNumberOfLeadingZeros(a.getNumberOfLeadingZerosOrDefault()));
                        return b
                    }
                    ;
                    i18n.phonenumbers.PhoneNumberUtil.prototype.isNumberMatch = function(a, b) {
                        ...
                        if ("string" == typeof b)
                            try {
                                return e = this.parse(b, i18n.phonenumbers.PhoneNumberUtil.UNKNOWN_REGION_),
                                this.isNumberMatch(a, e)
                            } catch (f) {
...
*/
                    ...
                    i18n.phonenumbers.ShortNumberInfo.prototype.isPossibleShortNumber = function(a) {
                        ...
                        for (var c = 0; c < b.length; c++) {
                            ...
                            if (d && d.getGeneralDesc().possibleLengthArray().includes(a))
                                return !0
                        }
                        return !1
                    }
                    ...
                    i18n.phonenumbers.ShortNumberInfo.prototype.isValidShortNumberForRegion = function(a, b) {
                        ...
                        if (!this.matchesPossibleNumberAndNationalNumber_(a, c))
                            return !1;
                        b = b.getShortCode();
                    ...
                    i18n.phonenumbers.ShortNumberInfo.prototype.getRegionCodeForShortNumberFromRegionList_ = function(a, b) {
                        ...
                        for (var c = 0; c < b.length; c++) {
                            ...
                            if (e && this.matchesPossibleNumberAndNationalNumber_(a, e.getShortCode()))
                                return d
                        }
                        return null
                    }
                    ...
                    i18n.phonenumbers.AsYouTypeFormatter.prototype.maybeCreateNewTemplate_ = function() {
                        for (var a = this.possibleFormats_.length, b = 0; b < a; ++b) {
                            ...
                            if (this.createFormattingTemplate_(c))
                                return this.currentFormattingPattern_ = d,
                    ...
                    i18n.phonenumbers.AsYouTypeFormatter.prototype.createFormattingTemplate_ = function(a) {
                        ...
                        return 0 < a.length ? (this.formattingTemplate_.append(a),
                        !0) : !1
                    }
                    ;
                    ...
                    i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToFormatAccruedDigits_ = function() {
                        for (var a = this.nationalNumber_.toString(), b = this.possibleFormats_.length, c = 0; c < b; ++c) {
                            ...
                            d = a.replace(new RegExp(e,"g"), d.getFormat()),
                            d = this.appendNationalNumber_(d),
                            i18n.phonenumbers.PhoneNumberUtil.normalizeDiallableCharsOnly(d) == this.accruedInputWithoutFormatting_))
                                return d
                        }
                        return ""
                    }
                    ...
                    i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToChooseFormattingPattern_ = function() {
                        ...
                        a = this.attemptToFormatAccruedDigits_(),
                        0 < a.length ? a : this.maybeCreateNewTemplate_() ? this.inputAccruedNationalNumber_() : this.accruedInput_.toString()) : this.appendNationalNumber_(a)
                    }
                    ;
                    ...
                    i18n.phonenumbers.AsYouTypeFormatter.prototype.removeNationalPrefixFromNationalNumber_ = function() {
                        ...
                        if (this.isNanpaNumberWithNationalPrefix_())
                            ...
                            c = a.match(c);
                            null != c && null != c[0] && 0 < c[0].length && (this.isCompleteNumber_ = !0,
                            b = c[0].length,
                            this.prefixBeforeNationalNumber_.append(a.substring(0, b)))
                        }
                        this.nationalNumber_.clear();
                    ...
                    i18n.phonenumbers.AsYouTypeFormatter.prototype.normalizeAndAccrueDigitsAndPlusSign_ = function(a, b) {
                        if (a == i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN) {
                            ...
                            c = i18n.phonenumbers.PhoneNumberUtil.DIGIT_MAPPINGS[a],
                            this.accruedInputWithoutFormatting_.append(c),
